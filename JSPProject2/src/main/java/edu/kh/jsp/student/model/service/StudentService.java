...
public class StudentService {
	...
	// art + shift + j : 클래스/메서드 설명용 주석 (HTML 작성법)
	/** 학생 전체 조회 서비스
	 * @return stdList
	 * @throws Exception
	 */
	 ...
	 * @throws Exception
	 */
	public List<Student> selectDept(String inputDept) throws Exception {
		
		Connection conn = getConnection();
		
		List<Student> deptList = dao.selectDept(conn, inputDept);
