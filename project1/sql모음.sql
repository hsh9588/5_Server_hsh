...
--
---- 수업용 프로젝트 계정 생성
--CREATE USER project_hsh IDENTIFIED BY project1234;
--
---- 권한 부여
--GRANT CONNECT, RESOURCE, CREATE VIEW TO project_hsh;
--
---- 객체 생성 공간 할당
--ALTER USER project_hsh DEFAULT TABLESPACE SYSTEM
...
INSERT INTO "MEMBER"
VALUES(SEQ_MEMBER_NO.NEXTVAL, 'user02@kh.or.kr', 'pass02!', '이유저', '01022332244', 
...
SELECT MEMBER_NO, MEMBER_EMAIL, MEMBER_NICKNAME, MEMBER_TEL, 
	MEMBER_ADDRESS, PROFILE_IMG, AUTHORITY, TO_CHAR(ENROLL_DATE, 'YYYY"년" MM"월" DD"일" HH24"시" MI"분" SS"초"') AS ENROLL_DATE
FROM "MEMBER"
...
UPDATE "MEMBER" SET
MEMBER_PW = '$2a$10$HLSl74KqFeeQRFzfkgBLEucsukeRJPammBIA1/uPNrFiAMiTv/R2W'
WHERE MEMBER_NO = 1;

UPDATE "MEMBER" SET
MEMBER_PW = '$2a$10$58r.UptU5LMp43O.pOYjoOVcRp7c8dRzD/HUmzLciVzQx./6dq/qi'
WHERE MEMBER_NO = 2;

UPDATE "MEMBER" SET
MEMBER_PW = '$2a$10$aZ9aRwtzz/Ok7pftn7WZc.r32SX74Rvc2HOL8MJ.7dYgB2wkdI6Dq'
WHERE MEMBER_NO = 3;

UPDATE "MEMBER" SET
MEMBER_PW = '$2a$10$esJfEnlRaRBj6SnYgZ.KGerEMh8UFmV.qagDvNqRY2vmK5tC31jh6'
WHERE MEMBER_NO = 4;
