    ...
    <main>
        ...
        <section class="signUp-content">
            ...
            <form action="/member/signUp" method="POST" name="signUp-frm" id="signUp-frm">
                ...
                <span class="signUp-message">메일을 받을 수 있는 이메일 입력해주세요.</span>
                ...
                <div class="signUp-input-area">
                    ...
                    placeholder="우편번호" maxlength="11" required>

                    <button type="button">검색</button>
                </div>

                <div class="signUp-input-area">
                    <input type="text" name="memberAddress" placeholder="도로명/지번 주소" required>
                </div>
                <div class="signUp-input-area">
